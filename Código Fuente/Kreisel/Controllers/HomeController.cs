...
namespace Kreisel.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Productos(int anio = 2019, string categoria = null)
        {
            ...
            using (var connection = new SqlConnection(_configuration.GetConnectionString("DefaultConnection")))
            {
                ...
                var cmdCategorias = new SqlCommand(basedeDatos.ObtenerCategorias, connection);
                ...
                {
                    var cmdProductos = new SqlCommand(basedeDatos.ObtenerProductos, connection);
